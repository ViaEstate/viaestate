-- Update XML import function to support extended real estate format (xml2u.com)
-- This replaces the existing process_xml_properties function

-- Drop the existing function
DROP FUNCTION IF EXISTS process_xml_properties(TEXT, UUID);
